...
<main id="main-content">
    ...
    <header class="page-hero text-white py-5" style="background: linear-gradient(135deg, #0056D2, #00C9A7);">
        <div class="container mt-5 pt-5 pb-4 text-center">
            ...
            <h1 class="display-4 fw-bold mb-3">Proven RCM Case Studies</h1>
            <p class="lead mb-4 mx-auto" style="max-width: 800px;">We do not rely on estimates. Explore detailed, metric-driven examples of how our dedicated medical billing divisions have systematically eliminated denials and maximized practice revenue.</p>
        </div>
    </header>
            ...
            <div class="card shadow-sm border-0 mb-5 overflow-hidden">
                <div class="row g-0">
                    <div class="col-lg-4 bg-primary text-white p-5 d-flex flex-column justify-content-center">
                        ...
                        <h2 class="h3 fw-bold mb-3">35% Revenue Increase in 90 Days</h2>
                        <ul class="list-unstyled mb-0 mt-3 fs-5">
                            <li class="mb-2"><i class="ph ph-chart-line-up text-success me-2"></i> <strong>+$115,400</strong> Monthly</li>
                    ...
                    <div class="col-lg-8 p-5">
                        ...
                        <p>A multi-provider internal medicine group was experiencing a stagnant cash floor despite increasing patient volume. Their internal billing team, fearful of Medicare RAC audits, established a strict internal policy forcing all Evaluation & Management (E/M) visits to be coded as a Level 3 (99213) or lower, regardless of clinical complexity or physician time spent.</p>

                        <h3 class="h4 fw-bold text-dark mt-4 mb-3">The Medinext Solution</h3>
                        <p>MEDINEXT SOLUTIONS's AAPC-certified auditing team conducted a 100-chart sample review based on the updated AMA Medical Decision Making (MDM) guidelines. We discovered that 42% of the visits were legally sound Level 4 (99214) encounters involving systemic illness and prescription drug management.</p>
                        ...
                        <p class="mb-0 fw-medium">Within 90 days, the practice's E/M bell curve normalized against the national average. Gross collections increased by 35% without adding a single new patient to the schedule, yielding over $1.3 million in additional annualized revenue.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-5 overflow-hidden">
                <div class="row g-0 flex-lg-row-reverse">
                    <div class="col-lg-4 bg-dark text-white p-5 d-flex flex-column justify-content-center">
                        ...
                        <h2 class="h3 fw-bold mb-3">Denial Rate Plummets from 18% to 3%</h2>
                        <ul class="list-unstyled mb-0 mt-3 fs-5">
                            <li class="mb-2"><i class="ph ph-trend-down text-success me-2"></i> <strong>-83%</strong> Denial Drop</li>
                    ...
                    <div class="col-lg-8 p-5">
                        ...
                        <p>A prominent orthopedic surgery center was suffering an 18% clean claim failure rate. The primary culprit was commercial insurers aggressively denying complex multi-site procedures (like spinal fusions and major joint revisions) as "inclusive" (CO-97) to the primary procedure code.</p>

                        <h3 class="h4 fw-bold text-dark mt-4 mb-3">The Medinext Solution</h3>
                        <p>Our surgical coding specialists isolated the surgical matrix. The client's previous billing firm was misusing general modifiers, triggering automated NCCI scrubbers.</p>
                        <ul class="mb-4 text-muted">
                        ...
                        <h3 class="h4 fw-bold text-dark">The Financial Result</h3>
                        <p class="mb-0 fw-medium">The practice's initial clean claim pass-rate surged to 97%. Days in Accounts Receivable (AR) dropped from 68 days to 24 days, drastically hyper-accelerating cash flow and entirely eliminating the administrative cost of working frontend rejections.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-5 overflow-hidden">
                <div class="row g-0">
                    <div class="col-lg-4 text-white p-5 d-flex flex-column justify-content-center" style="background: var(--bs-primary);">
                        ...
                        <h2 class="h3 fw-bold mb-3">$200,000 Recovered in Aging AR</h2>
                        <ul class="list-unstyled mb-0 mt-3 fs-5">
                            <li class="mb-2"><i class="ph ph-coins text-success me-2"></i> <strong>+$212,850</strong> Recovered</li>
                    ...
                    <div class="col-lg-8 p-5">
                        ...
                        <h3 class="h4 fw-bold text-dark mt-4 mb-3">The Medinext Solution</h3>
                        <p>MEDINEXT SOLUTIONS deployed an emergency Denial Management AR Task Force.</p>
                        <ul class="mb-4 text-muted">
                        ...
                        <h3 class="h4 fw-bold text-dark">The Financial Result</h3>
                        <p class="mb-0 fw-medium">Within 60 days of taking over the aging buckets, MEDINEXT SOLUTIONS successfully forced commercial payers and Medicare to overturn the filing denials, recovering over $212,000 in clean cash that the practice had literally already written off their ledger.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 text-center text-white" style="background: var(--bs-dark);">
        <div class="container py-4">
            <h2 class="display-5 fw-bold mb-3">Ready for Similar Results?</h2>
            <p class="lead mb-4 mx-auto" style="max-width: 700px;">Stop reading about other practices recovering their revenue. Let MEDINEXT SOLUTIONS uncover the exact financial leaks in your current billing cycle.</p>
            <a href="free-practice-audit/" class="btn btn-primary btn-lg px-5 py-3 fw-bold shadow-lg">Request Your Free Practice Audit</a>
        </div>
    </section>
</main>
